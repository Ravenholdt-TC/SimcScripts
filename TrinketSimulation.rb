...
template = Interactive.SelectTemplate('TrinketSimulation')
trinketListProfile = Interactive.SelectTemplate('TrinketList')
fightstyle = Interactive.SelectTemplate('Fightstyle')

trinketList = JSONParser.ReadFile("#{SimcConfig::ProfilesFolder}/TrinketList_#{trinketListProfile}.json")
...
params = [
  ...
  "#{SimcConfig::ProfilesFolder}/TrinketSimulation_#{template}.simc",
  simcfile
]
